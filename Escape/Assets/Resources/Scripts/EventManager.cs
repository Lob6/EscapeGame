...
public class EventParamRobot : EventParam
{
    private Vector2 value;
    public Vector2 Value { get => value; set => this.value = value; }
...
public class EventScanScreen : EventParam
{
    private int value;
    public int Value { get => value; set => this.value = value; }
}

public class EventParamScores : EventParam
{
    private Dictionary<string, float> value;
    public Dictionary<string, float> Value { get => value; set => this.value = value; }
}
